    ...
    <div class="one ppb_menu_with_image" style="position:relative;padding:40px 0 40px 0;">
        <div class="standard_wrapper">
            <div class="page_content_wrapper">
                <div class="inner">
                    <div class="one_half parallax_scroll" style="width:40%;position:absolute;left:90px;background:#ffffff;padding:40px;z-index:2;" data-stellar-ratio="1.3">
                        <h2 class="ppb_menu_title">KARİDESLİ BÖREK</h2>
                        <div id="menu_2878" class="menu_content_classic">
                            <h5 class="menu_post">
    ...
    <div class="one ppb_menu_with_image" style="position:relative;padding:40px 0 40px 0;">
        <div class="standard_wrapper">
            <div class="page_content_wrapper">
                <div class="inner">
                    <div class="one_half parallax_scroll" style="width:40%;position:absolute;left:90px;background:#ffffff;padding:40px;z-index:2;" data-stellar-ratio="1.3">
                        <h2 class="ppb_menu_title">SÜTLÜ DİL BALIĞI GÜVECİ</h2>
                        <div id="menu_2878" class="menu_content_classic">
                            <h5 class="menu_post">
    ...
    <div class="one ppb_menu_with_image" style="position:relative;padding:40px 0 40px 0;">
        <div class="standard_wrapper">
            <div class="page_content_wrapper">
                <div class="inner">
                    <div class="one_half parallax_scroll" style="width:40%;position:absolute;left:90px;background:#ffffff;padding:40px;z-index:2;" data-stellar-ratio="1.3">
                        <h2 class="ppb_menu_title">İSTANBUL PİLAVI</h2>
                        <div id="menu_2878" class="menu_content_classic">
                            <h5 class="menu_post">
    ...
    <div class="one ppb_menu_with_image" style="position:relative;padding:40px 0 40px 0;">
        <div class="standard_wrapper">
            <div class="page_content_wrapper">
                <div class="inner">
                    <div class="one_half parallax_scroll" style="width:40%;position:absolute;left:90px;background:#ffffff;padding:40px;z-index:2;" data-stellar-ratio="1.3">
                        <h2 class="ppb_menu_title">SOĞANLI MUSKA BÖREĞİ</h2>
                        <div id="menu_2878" class="menu_content_classic">
                            <h5 class="menu_post">
    ...
    <div class="one ppb_menu_with_image" style="position:relative;padding:40px 0 40px 0;">
        <div class="standard_wrapper">
            <div class="page_content_wrapper">
                <div class="inner">
                    <div class="one_half parallax_scroll" style="width:40%;position:absolute;left:90px;background:#ffffff;padding:40px;z-index:2;" data-stellar-ratio="1.3">
                        <h2 class="ppb_menu_title">HÖŞMERİM</h2>
                        <div id="menu_2878" class="menu_content_classic">
                            <h5 class="menu_post">
